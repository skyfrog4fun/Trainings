...
namespace Trainings.Infrastructure.Migrations
{
    ...
    [Migration("20260925171821_TrainingLifecycleFeedbackRedesign")]
    partial class TrainingLifecycleFeedbackRedesign
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Trainings.Domain.Entities.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Trainings.Domain.Entities.GroupLocation", b =>
                {
            ...
            modelBuilder.Entity("Trainings.Domain.Entities.Location", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Trainings.Domain.Entities.MailConfiguration", b =>
                {
                    ...
                    b.Property<DateTime?>("LastSuccessSentAt")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Trainings.Domain.Entities.NotificationFeedState", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<int?>("ResetPointerLogId")
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("NotificationFeedStates");
                });
            ...
            modelBuilder.Entity("Trainings.Domain.Entities.ParticipantFeedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Trainings.Domain.Entities.TrainerFeedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Trainings.Domain.Entities.Training", b =>
                {
                    ...
                    b.Property<bool>("AttendanceLocked")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("SpecialLocationDescription")
                        .HasMaxLength(500)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Trainings.Domain.Entities.Group", b =>
                {
                    b.HasOne("Trainings.Domain.Entities.Country", "Country")
                        .WithMany("Groups")
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Trainings.Domain.Entities.Location", "Location")
                        .WithMany("DefaultForGroups")
            ...
            modelBuilder.Entity("Trainings.Domain.Entities.Location", b =>
                {
                    b.Navigation("AllowedForGroups");

                    b.Navigation("DefaultForGroups");
