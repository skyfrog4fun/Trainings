...
public interface INotificationLogService
{
    ...
    Task<IReadOnlyList<NotificationLog>> GetRecentLogsAsync(int count = 50, int? afterLogId = null, CancellationToken ct = default);
    ...
    Task<int?> GetResetPointerLogIdAsync(CancellationToken ct = default);
    Task SetResetPointerLogIdAsync(int? logId, CancellationToken ct = default);
}
